...
public class LifeCycle2 extends HttpServlet{
	...
	*/
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		response.sendRedirect(request.getContextPath()+"/study/1119LifeCycle/test1Res2.jsp?title="+title+"&conten="+content);
	...
	private void initpostConstruct() {
		System.out.println("--- 이곳은 initpostConstruct() 메소드 입니다.... ---");
	}
	
	@PreDestroy
	private void destroyPreDestroy() {
		System.out.println("--- 이곳은 destroyPreDestroy() 메소드 입니다.... ---");
	}
