...
<div class="container">
  <form name="myform" method="post" action="${ctp}/boInputOk.bo">
  	...
  	<table class="table">
  		...
  		<tr>
  			<th>홈페이지</th>
  			<td><input type="text" name="email" id="email" placeholder="홈페이지 주소를 입력하세요" value="${homePage}" class="form-control"/></td>
  		</tr>
  		<tr>
  			<th>글내용</th>
  		...
  		<tr>
  			<td colspan="2" class="text-center">
  				...
  				<input type="button" value="돌아가기"  onclick="location.href='${ctp}/boList.bo';" class="btn btn-primary" />
  			</td>
  		</tr>
  	</table>
